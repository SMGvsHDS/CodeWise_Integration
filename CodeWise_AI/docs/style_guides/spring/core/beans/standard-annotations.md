...
{
private
Provider<MovieFinder> movieFinder;
@Inject
public
void
setMovieFinder
...
lateinit
var
movieFinder: Provider<MovieFinder>
fun
listMovies
()
{
...
or
@Nullable
. This is even more applicable here, since
@Inject
does not have
a
required
attribute. The following pair of examples show how to use
@Inject
and
@Nullable
:
...
@Inject
@Inject
has no 'required' attribute. Can be used with Java 8’s
Optional
instead.
@Component
@Named / @ManagedBean
...
container is a
singleton
by default. In order to use a scope other than
singleton
,
...
Provider
jakarta.inject.Provider
is a direct alternative to Spring’s
ObjectFactory
,
only with a shorter
get()
