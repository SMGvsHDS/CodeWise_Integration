...
passed in but also registers a number of additional error codes. The
MessageCodesResolver
determines which error codes the
Errors
...
to the reject method. So, if you reject a field by using
rejectValue("age", "too.darn.old")
,
apart from the
too.darn.old
code, Spring also registers
too.darn.old.age
and
