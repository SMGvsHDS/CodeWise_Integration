...
⌘ + k
Application Startup Steps
This part of the appendix lists the existing
StartupSteps
...
beanType
the type required at the injection point.
...
packages
array of base packages for scanning.
...
.
classes
array of given classes for registration.
