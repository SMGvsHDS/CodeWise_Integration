...
Jakarta Expression
Language
but offers additional features, most notably method invocation and basic string
...
for code completion support within the
...
syntax. In several places,
Inventor
and
Society
classes are used as the target
