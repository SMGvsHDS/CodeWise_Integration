# Applying More Than Just Tx Advice
...
applies to transactions). See
AOP
for detailed coverage of the AOP
...
returnValue: Any
val
clock = StopWatch(javaClass.name)
try
{
clock.start(call.toShortString())
returnValue = call.proceed()
...
Copied!
```
The result of the preceding configuration is a
fooService
bean that has profiling and
