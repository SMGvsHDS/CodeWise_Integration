...
SQLException
to its own exception class hierarchy, which has
DataAccessException
as
...
private
val
sessionFactory: SessionFactory) : MovieFinder {
// ...
}
Copied!
```
...
JdbcTemplate
and other data access support classes (such as
SimpleJdbcCall
and others) by using this
DataSource
. The following example autowires a
DataSource
:
Java
Kotlin
...
class
JdbcMovieFinder
(dataSource: DataSource) : MovieFinder {
private
val
