...
WebTestClient
, there is nothing special to do to make
asynchronous requests work as the
WebTestClient
automatically does what is described
in this section.
Servlet asynchronous requests,
supported in Spring MVC
,
...
Below is an example test for controller methods that return
DeferredResult
,
Callable
,
or reactive type such as Reactor
Mono
:
Java
Kotlin
