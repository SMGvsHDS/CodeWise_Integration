# Vs End To End Integration Tests
...
are that there is no context path by default; no
jsessionid
...
for rendering JSON, XML, and other formats through
@ResponseBody
methods.
...
, what the content of the model is, what binding
