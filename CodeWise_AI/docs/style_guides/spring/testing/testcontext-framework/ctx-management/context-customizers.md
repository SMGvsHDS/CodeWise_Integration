...
ContextCustomizer
, based on
some custom logic which determines if the
ContextCustomizer
...
will be
merged
with the default factories that have been registered using the aforementioned
