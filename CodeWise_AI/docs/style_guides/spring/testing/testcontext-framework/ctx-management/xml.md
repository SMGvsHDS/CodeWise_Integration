...
is treated as an absolute classpath location (for example,
/org/example/config.xml
). A
path that represents a resource URL (i.e., a path prefixed with
classpath:
,
file:
,
...
attributes in
@ContextConfiguration
, you can omit the declaration of the
locations
