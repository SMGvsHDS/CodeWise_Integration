...
As of Spring Framework 6.1, a context
failure threshold
policy is in place which helps
...
subsequent attempt to load the
ApplicationContext
...
test suites to fail faster by avoiding repeated attempts to load an
ApplicationContext
...
by setting a JVM system property named
