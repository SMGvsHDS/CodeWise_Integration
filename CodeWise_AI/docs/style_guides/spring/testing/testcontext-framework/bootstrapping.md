...
third party framework would like to change the default
ContextLoader
, implement a
custom
TestContext
...
test class (or test class hierarchy) by using
@BootstrapWith
...
is used, depending on the presence of
@WebAppConfiguration
.
Since the
TestContextBootstrapper
