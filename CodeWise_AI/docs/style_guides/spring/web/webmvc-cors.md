...
in a single global map being passed to all
HandlerMapping
instances.
...
Java Configuration
See equivalent in the Reactive stack
To enable CORS in the MVC Java config, you can use the
CorsRegistry
callback,
as the following example shows:
Java
...
```
XML Configuration
To enable CORS in the XML namespace, you can use the
<mvc:cors>
element,
as the following example shows:
```
