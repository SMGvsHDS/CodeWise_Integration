...
account[KEY].name
.
WebFlux, unlike Spring MVC, supports reactive types in the model, for example,
Mono<Account>
.
You can declare a
@ModelAttribute
...
Using
@ModelAttribute
is optional. By default, any argument that is not a simple
