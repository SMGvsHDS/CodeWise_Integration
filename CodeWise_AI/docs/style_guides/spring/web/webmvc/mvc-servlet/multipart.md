...
To enable multipart handling, you need to declare a
MultipartResolver
bean in your
DispatcherServlet
Spring configuration with a name of
multipartResolver
.
The
DispatcherServlet
...
The following example shows how to set a
MultipartConfigElement
on the Servlet registration:
Java
Kotlin
