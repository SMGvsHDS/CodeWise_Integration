...
⌘ + k
Default Servlet
Spring MVC allows for mapping the
DispatcherServlet
to
/
...
remain last in the order of all other URL
HandlerMappings
. That is the
case if you use
...
public
class
CustomDefaultServletConfiguration
implements
WebMvcConfigurer
{
@Override
