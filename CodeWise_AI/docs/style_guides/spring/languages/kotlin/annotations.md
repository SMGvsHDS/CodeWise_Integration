...
⌘ + k
Annotations
The Spring Framework also takes advantage of
Kotlin null-safety
...
is treated
as not required and, conversely,
@RequestParam name: String
is treated as being required.
This feature is also supported on the Spring Messaging
@Header
annotation.
...
@Bean fun play(toy: Toy, car: Car?) = Baz(toy, car)
implies
that a bean of type
Toy
