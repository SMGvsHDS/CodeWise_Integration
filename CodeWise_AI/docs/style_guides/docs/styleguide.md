...
> 원문: https://google.github.io/styleguide/docguide/style.html
...
TheMarkdown wayencourages engineers to take ownership of their docs and
...
productivewhen making short-term improvements. Set lower standards for each
CL, so thatmore such CLscan happen.
...
to avoid comments of the form “You shouldalso…”.
...
put[TOC]after the short introduction. See[TOC]documentation.
...
Use a[TOC]directiveunless all
of your content is above the fold1on a laptop.
...
For users who read your documentation visually, it doesn’t matter where your[TOC]directive is placed, as Markdown always displays the TOC toward the top and
...
H2 or deeper. SeeDocument layoutfor more information.
...
`Backticks` designateinline codethat will be rendered literally. Use
...
- Use images when it’s easier toshowa reader something than todescribe
...
- Rambling prosein some cells. Tables should tell a succinct story at a
glance.
...
Listsand subheadings sometimes suffice to present the same
...
Note thatreference linksare used to keep the table cells
manageable.
...
need it. Except forbig tables, Markdown meets almost all needs
already.
...
tools, which may either present the source as plain text or render it. SeePhilosophy.
